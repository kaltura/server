...
class languageCodeManager
{
    ...
    private static function generateCacheFile()
    {
        ...
        self::addLanguageToArrays($tmpArrKeyCode,$tmpArrThreeCodeT,$tmpArrThreeCodeB,$tmpArrKalturaName,'AR_LB', "ar_lb", "ar_lb", "ar_lb", "Arabic (Lebanon)", "Arabic (Lebanon)",'Arabic (Lebanon)');
        self::addLanguageToArrays($tmpArrKeyCode,$tmpArrThreeCodeT,$tmpArrThreeCodeB,$tmpArrKalturaName,'AR_QA', "ar_qa", "ar_qa", "ar_qa", "Arabic (Qatar)", "Arabic (Qatar)",'Arabic (Qatar)');
        self::addLanguageToArrays($tmpArrKeyCode,$tmpArrThreeCodeT,$tmpArrThreeCodeB,$tmpArrKalturaName,'AR_SA', "ar_sa", "ar_sa", "ar_sa", "Arabic (Saudi Arabia)", "Arabic (Saudi Arabia)",'Arabic (Saudi Arabia)');
