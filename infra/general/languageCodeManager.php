...
class languageCodeManager
{
    ...
    private static function generateCacheFile()
    {
		...
		self::addLanguageToArrays($tmpArrKeyCode,$tmpArrThreeCodeT,$tmpArrKalturaName,'ZH_T', "zh_t", "zht", "cht", "Chinese (Traditional)");
		self::addLanguageToArrays($tmpArrKeyCode,$tmpArrThreeCodeT,$tmpArrKalturaName,'ZH_S', "zh_s", "zhs", "chs", "Chinese (Simplified)");
