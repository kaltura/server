...
class AkamaiHttpDownloadsReportServiceClient extends AkamaiClient
{
	const WSDL_URL = 'https://control.akamai.com/nmrws/services/HttpDownloadsReportService?wsdl';
	...
	public function getTopDownloadsByCountryForCPCode($cpcode, $date, $columns)
	{
		$params = array();
		...
		$result = $this->call("getTopDownloadsByCountryForCPCode", $params);
		$this->logError();
		return $result;
	}
	
	public function getTopDownloadsByCountryForReportGroup($repgrp, $date, $columns)
	{
		$params = array();
		...
		$result = $this->call("getTopDownloadsByCountryForReportGroup", $params);
		$this->logError();
		return $result;
	}
	
	public function getTopDownloadsByUSStateForCPCode($cpcode, $date, $columns)
	{
		$params = array();
		...
		$result = $this->call("getTopDownloadsByUSStateForCPCode", $params);
		$this->logError();
		return $result;
	}
	
	public function getTopDownloadsByUSStateForReportGroup($repgrp, $date, $columns)
	{
		$params = array();
		...
		$result = $this->call("getTopDownloadsByUSStateForReportGroup", $params);
		$this->logError();
		return $result;
	}
	
	public function getTopDownloadsCAProvinceForCPCode($cpcode, $date, $columns)
	{
		$params = array();
		...
		$result = $this->call("getTopDownloadsCAProvinceForCPCode", $params);
		$this->logError();
		return $result;
	}
	
	public function getTopDownloadsByCAProvinceForReportGroup($repgrp, $date, $columns)
	{
		$params = array();
		...
		$result = $this->call("getTopDownloadsByCAProvinceForReportGroup", $params);
		$this->logError();
		return $result;
	}
	
	public function getCurrentGeoMap($cpcodes, $network, $graphType, $mapScale)
	{
		$params = array();
		
		$params["cpcodes"] = $this->parseParam($cpcodes, 'akasiteDeldt:ArrayOfInt');
		$params["network"] = $this->parseParam($network, 'akaaimsdt:NetworkTypeEnum');
