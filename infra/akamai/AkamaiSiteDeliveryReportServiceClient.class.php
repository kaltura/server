...
class AkamaiSiteDeliveryReportServiceClient extends AkamaiClient
{
	const WSDL_URL = 'https://control.akamai.com/nmrws/services/SiteDeliveryReportService?wsdl';
	...
	public function getCurrentGeoMap($cpcodes, $contentType, $network, $graphType, $mapScale)
	{
		$params = array();
		
		$params["cpcodes"] = $this->parseParam($cpcodes, 'akasiteDeldt:ArrayOfInt');
		$params["contentType"] = $this->parseParam($contentType, 'akaaimsdt:ContentTypeEnum');
