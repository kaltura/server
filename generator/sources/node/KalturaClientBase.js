 ...
 * provided. Ported from PHP.
 * 
 * @param formdata
 *            May be an array or object containing properties.
 * @param numeric_prefix
 *            If numeric indices are used in the base array and this parameter
 *            is provided, it will be prepended to the numeric index for
 *            elements in the base array only.
 * @param arg_separator
 *            arg_separator.output is used to separate arguments, unless this
 ...
 * which if it has modified (and is therfor invalid to use), it falls back to
 * using Object.prototype.toString to get the class though it won't return the
 * name of the constructor function that created it then. If you absolutely need
 * the constructor's name, pass true as the second argument, and it will reset
 * the constructor if it has been modified, to get the real constructor.
 * 
 * @param obj
 *            The object to get the constructor of.
 * @param forceConstructor
 *            preform a deep lookup for the real constructor.
 ...
 * 
 * @param obj
 *            The object who's members to serialize.
...
/**
 * validate a paramter's value is not null, if not null, add the parameter to
 * the collection.
 * 
 * @param params
 *            the collection of parameters to send in a service action request.
 * @param paramName
 *            the new parameter name to add.
 * @param paramValue
 *            the new parameter value to add.
 */
...
/**
 * Construct new Kaltura service action call, if params array contain sub-arrays
 * (for objects), it will be flattened.
 * 
 * @param string
 *            service The Kaltura service to use.
 * @param string
 *            action The service action to execute.
 * @param array
 *            params The parameters to pass to the service action.
 * @param array
 *            files Files to upload or manipulate.
 */
 ...
 * 
 * @param int
 *            multiRequestIndex the index of the call inside the multirequest.
 */
...
/**
 * @param string
 *            ks setter for the Kaltura session.
 */
...
/**
 * @param KalturaConfiguration
 *            config setter for the referenced configuration object.
 */
 ...
 * 
 * @param array
 *            params array of parameters to pass to a call.
 * @param string
 *            paramName the name of the new parameter to add.
 * @param string
 *            paramValue the value of the new parameter to add.
 */
...
/**
 * Abstract base class for all client services Initialize the service keeping
 * reference to the KalturaClient
 * 
 * @param KalturaClientm
 *            client
 */
