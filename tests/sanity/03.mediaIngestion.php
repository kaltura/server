...
$manifestUrl = "http://{$clientConfig->serviceUrl}/p/{$createdEntry->partnerId}/sp/{$createdEntry->partnerId}00/playManifest/entryId/{$createdEntry->id}/a/a.f4m";
...
$downloadUrl = "http://{$clientConfig->serviceUrl}/p/{$createdEntry->partnerId}/sp/{$createdEntry->partnerId}00/download/entry_id/{$createdEntry->id}";
