...
abstract class KalturaFtpDropFolderBaseFilter extends KalturaDropFolderFilter
{
...
abstract class KalturaSshDropFolderBaseFilter extends KalturaDropFolderFilter
{
...
class KalturaFtpDropFolder extends KalturaDropFolder
{
	 ...
	 * @var string
	 */
	public $remoteFolderPath = null;


}

abstract class KalturaSshDropFolder extends KalturaDropFolder
{
	/**
	 * 
	 *
