...
ALTER TABLE `drop_folder_file` ADD COLUMN `entry_id` VARCHAR(20) AFTER `deleted_drop_folder_file_id`;
ALTER TABLE `drop_folder_file` ADD COLUMN `upload_end_detected_at` DATETIME AFTER `updated_at`;
...
ALTER TABLE `drop_folder_file` ADD UNIQUE KEY `file_name_in_drop_folder_unique` (`file_name`, `drop_folder_id`, `deleted_drop_folder_file_id`);