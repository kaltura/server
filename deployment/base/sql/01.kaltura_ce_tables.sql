...
(
	...
	`partner_id` INTEGER   AUTO_INCREMENT,
	`vendor_partner_id` INTEGER   AUTO_INCREMENT,
	`entry_id` VARCHAR(31)   AUTO_INCREMENT,
	`status` TINYINT   AUTO_INCREMENT,
	`price` INTEGER   AUTO_INCREMENT,
	`catalog_item_id` INTEGER   AUTO_INCREMENT,
	`vendor_profile_id` INTEGER   AUTO_INCREMENT,
	`kuser_id` INTEGER   AUTO_INCREMENT,
	`version` INTEGER,
	`context` VARCHAR(256),
	`custom_data` TEXT,
	PRIMARY KEY (`id`),
