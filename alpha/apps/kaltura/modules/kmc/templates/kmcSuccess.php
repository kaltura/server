...
<script type="text/javascript">
	...
	if ( !loginF ( null , null , null , null , true ) ) {
		...
		var params = {
			...
			quality: "high",
			wmode: "window" ,
			movie: "<?php echo $flash_dir ?>/kmc/login/v1.1.6/login.swf"
		};
		swfobject.embedSWF("<?php echo $flash_dir ?>/kmc/login/v1.1.6/login.swf", "login_swf", "384", "350", "9.0.0", false, flashVars, params);
	}
</script>
