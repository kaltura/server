...
class kSessionTypeCondition extends kCondition
{
	...
	protected function internalFulfilled(kScope $scope)
	{
		...
		$isInternalRequest =  $this->isInternalRequest();
		...
		{
			KalturaLog::debug("Bypassing session type condition check [$isInternalRequest] [$disableConditionCheck]");
			return $this->not;
		}
	...
	{
		$requestIp = requestUtils::getRemoteAddress();
