...
class kCoreException extends Exception
{
	...
	const INVALID_APP_GUID = 'INVALID_APP_GUID';
	
	const APP_GUID_NOT_FOUND = 'APP_GUID_NOT_FOUND';
	
	const USER_APP_ROLE_ALREADY_EXISTS = 'USER_APP_ROLE_ALREADY_EXISTS';
	
	const USER_APP_ROLE_NOT_FOUND = 'USER_APP_ROLE_NOT_FOUND';
	
	const CANNOT_RETRIEVE_ANOTHER_USER_USING_NON_ADMIN_SESSION = 'CANNOT_RETRIEVE_ANOTHER_USER_USING_NON_ADMIN_SESSION';
	
	const FAILED_TO_INSTANTIATE_MICROSERVICE_CACHE = 'FAILED_TO_INSTANTIATE_MICROSERVICE_CACHE';
}
