...
class kUploadTokenException extends kCoreException
{
	...
	const UPLOAD_TOKEN_MULTIPART_UPLOAD_ERROR  = "UPLOAD_TOKEN_MULTIPART_UPLOAD_ERROR";

	const UPLOAD_TOKEN_INVALID_CHUNK_SIZE  = "UPLOAD_TOKEN_INVALID_CHUNK_SIZE";

	const UPLOAD_TOKEN_MULTIPART_CACHE_NOT_INITIALIZED = "UPLOAD_TOKEN_MULTIPART_CACHE_NOT_INITIALIZED";

	const UPLOAD_TOKEN_MULTIPART_CACHE_FAILURE = "UPLOAD_TOKEN_MULTIPART_CACHE_FAILURE";

	const UPLOAD_TOKEN_PROCESSING_FAILURE = "UPLOAD_TOKEN_PROCESSING_FAILURE";
}