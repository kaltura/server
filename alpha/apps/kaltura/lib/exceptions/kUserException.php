...
class kUserException extends kCoreException
{
	...
	const CANNOT_UPDATE_PASSWORD = 'CANNOT_UPDATE_PASSWORD';
	...
	const SETTING_SSO_PER_USER_NOT_ALLOWED = 'SETTING_SSO_PER_USER_NOT_ALLOWED';
	
	const COMMON_PASSWORD_NOT_ALLOWED = 'COMMON_PASSWORD_NOT_ALLOWED';

	const EMAIL_DOMAIN_IS_NOT_ALLOWED_FOR_ADMINS = 'EMAIL_DOMAIN_IS_NOT_ALLOWED_FOR_ADMINS';
}