...
class myPartnerRegistration
{
	...
	private  function sendRegistrationInformation(Partner $partner, kuser $adminKuser, $existingUser, $recipient_email = null , $partner_type = 1 )
	{
		...
		$avoidRegsitrationArray = array (PartnerPackages::PARTNER_PACKAGE_DEVELOPER_TRIAL,PartnerPackages::PARTNER_PACKAGE_DEVELOPER_COMMIT);
		if(in_array($partner->getPartnerPackage(),$avoidRegsitrationArray))
		{
			if ($existingUser) {
