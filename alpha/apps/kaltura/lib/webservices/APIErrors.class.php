...
class APIErrors 
{
	...
	const RECORDEDING_FLOW_NOT_COMPLETE = "RECORDEDING_FLOW_NOT_COMPLETE;ENTRY_ID;Live entry [@ENTRY_ID@] cannot be deleted, recording engien still proccesing live event";
