...
// -------------------------------------------- private -----------------------------------------------// 	
	...
	static function createUrl ($partner_id, $file_name)
	{
		...
		$url = myPartnerUtils::getRegionalCdnHost(null, null, null, kDataCenterMgr::getCurrentDcUrl()) . "/api_v3/index.php/service/report/action/serve/ks/$ksStr/id/$file_name/report.csv";
		return $url;
	}
