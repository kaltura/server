...
class kKavaQoeReports extends kKavaReportsMgr
{
	...
	protected static $reports_def = array(
		...
		ReportType::QOE_VOD_SESSION_FLOW => array(
			...
			self::REPORT_METRICS => array(self::EVENT_TYPE_PLAY_REQUESTED, self::EVENT_TYPE_PLAY, self::EVENT_TYPE_PLAYTHROUGH_25, self::EVENT_TYPE_PLAYTHROUGH_50, self::EVENT_TYPE_PLAYTHROUGH_75, self::EVENT_TYPE_PLAYTHROUGH_100, self::METRIC_ERROR_POSITION_COUNT, self::METRIC_ERROR_UNKNOWN_POSITION_COUNT)
		),

		ReportType::QOE_LIVE_SESSION_FLOW => array(
			self::REPORT_DATA_SOURCE => self::DATASOURCE_HISTORICAL,
			self::REPORT_PLAYBACK_TYPES => array(self::PLAYBACK_TYPE_LIVE, PLAYBACK_TYPE_DVR),
			self::REPORT_METRICS => array(self::EVENT_TYPE_PLAY_REQUESTED, self::EVENT_TYPE_PLAY, self::METRIC_ERROR_POSITION_COUNT, self::METRIC_ERROR_UNKNOWN_POSITION_COUNT)
		)
