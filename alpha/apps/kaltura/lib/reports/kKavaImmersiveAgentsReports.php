...
class kKavaImmersiveAgentsReports extends kKavaReportsMgr
{
	protected static $reports_def = array(
		...
		ReportType::IMMERSIVE_AGENTS_HIGHLIGHTS => array(
			self::REPORT_METRICS => array(self::METRIC_UNIQUE_THREADS, self::EVENT_TYPE_MESSAGE_RESPONSE, self::METRIC_AVG_MESSAGES, self::METRIC_UNIQUE_USERS, self::METRIC_CALL_UNIQUE_THREADS, self::METRIC_CALL_UNIQUE_USERS),
			self::REPORT_GRAPH_METRICS => array(self::METRIC_UNIQUE_THREADS, self::EVENT_TYPE_MESSAGE_RESPONSE, self::METRIC_AVG_MESSAGES, self::METRIC_UNIQUE_USERS, self::METRIC_CALL_UNIQUE_THREADS, self::METRIC_CALL_UNIQUE_USERS),
		),
