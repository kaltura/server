...
class kKavaEventPlatformReports extends kKavaReportsMgr
{
	protected static $reports_def = array(
		...
		ReportType::EP_WEBCAST_ENGAGEMENT => array(
			self::REPORT_UNION_DATA_SOURCES =>  array(self::DATASOURCE_HISTORICAL, self::DATASOURCE_MEETING_HISTORICAL),
			self::REPORT_METRICS => array(self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::METRIC_REACTION_CLICKED_USER_RATIO, self::METRIC_DOWNLOAD_ATTACHMENT_UNIQUE_USERS, self::EVENT_TYPE_REACTION_CLICKED),
			self::REPORT_GRAPH_METRICS => array(self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::METRIC_REACTION_CLICKED_USER_RATIO, self::METRIC_DOWNLOAD_ATTACHMENT_UNIQUE_USERS, self::EVENT_TYPE_REACTION_CLICKED),
			self::REPORT_TOTAL_METRICS => array(self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::METRIC_REACTION_CLICKED_USER_RATIO, self::METRIC_DOWNLOAD_ATTACHMENT_UNIQUE_USERS, self::EVENT_TYPE_REACTION_CLICKED)
		),
