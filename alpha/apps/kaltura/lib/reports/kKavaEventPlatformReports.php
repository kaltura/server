...
class kKavaEventPlatformReports extends kKavaReportsMgr
{
	protected static $reports_def = array(
		...
		ReportType::EP_WEBCAST_CNC_ENGAGEMENT => array(
			self::REPORT_JOIN_REPORTS => array(
				array(
					self::REPORT_UNION_DATA_SOURCES =>  array(self::DATASOURCE_HISTORICAL, self::DATASOURCE_MEETING_HISTORICAL),
					self::REPORT_METRICS => array(self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::METRIC_DOWNLOAD_ATTACHMENT_UNIQUE_USERS, self::EVENT_TYPE_DOWNLOAD_ATTACHMENT_CLICKED, self::METRIC_UNIQUE_COMBINED_LIVE_VIEW_PERIOD_USERS),
					self::REPORT_GRAPH_METRICS => array(self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::METRIC_DOWNLOAD_ATTACHMENT_UNIQUE_USERS, self::EVENT_TYPE_DOWNLOAD_ATTACHMENT_CLICKED, self::METRIC_UNIQUE_COMBINED_LIVE_VIEW_PERIOD_USERS),
					self::REPORT_TOTAL_METRICS => array(self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::METRIC_DOWNLOAD_ATTACHMENT_UNIQUE_USERS, self::EVENT_TYPE_DOWNLOAD_ATTACHMENT_CLICKED, self::METRIC_UNIQUE_COMBINED_LIVE_VIEW_PERIOD_USERS)
				),
				array(
					self::REPORT_DATA_SOURCE =>  self::DATASOURCE_CNC_EVENTS,
					self::REPORT_METRICS => array(self::METRIC_REACTION_CLICKED_UNIQUE_USERS, self::EVENT_TYPE_REACTION_CLICKED),
					self::REPORT_GRAPH_METRICS => array(self::METRIC_REACTION_CLICKED_UNIQUE_USERS, self::EVENT_TYPE_REACTION_CLICKED),
					self::REPORT_TOTAL_METRICS => array(self::METRIC_REACTION_CLICKED_UNIQUE_USERS, self::EVENT_TYPE_REACTION_CLICKED)
				)
			)
		),
		...
		ReportType::EP_WEBCAST_CNC_ENGAGEMENT_TIMELINE => array(
			self::REPORT_DIMENSION_MAP => array(
				'position' => self::DIMENSION_POSITION,
			),
			self::REPORT_JOIN_REPORTS => array(
				...
				array(
					self::REPORT_DATA_SOURCE => self::DATASOURCE_CNC_EVENTS,
					self::REPORT_METRICS => array(self::METRIC_REACTION_CLAP_COUNT, self::METRIC_REACTION_HEART_COUNT, self::METRIC_REACTION_THINK_COUNT, self::METRIC_REACTION_WOW_COUNT, self::METRIC_REACTION_SMILE_COUNT),
				)
			),
			self::REPORT_TABLE_FINALIZE_FUNC => "self::addZeroMinutes",
		),
		...
		ReportType::EP_WEBCAST_CNC_VOD_LIVE_USERS_ENGAGEMENT => array(
			self::REPORT_DIMENSION_MAP => array(
				'first_name' => self::DIMENSION_KUSER_ID,
				'last_name' => self::DIMENSION_KUSER_ID,
				'title' => self::DIMENSION_KUSER_ID,
