...
class kKavaEventPlatformReports extends kKavaReportsMgr
{
	protected static $reports_def = array(
		...
		ReportType::EP_WEBCAST_LIVE_USER_ENGAGEMENT => array(
			...
			self::REPORT_UNION_DATA_SOURCES => array(self::DATASOURCE_HISTORICAL, self::DATASOURCE_MEETING_HISTORICAL),
			self::REPORT_METRICS => array(self::METRIC_UNION_LIVE_MEETING_VIEW_TIME, self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::EVENT_TYPE_MEETING_RAISE_HAND, self::EVENT_TYPE_REACTION_CLICKED),
			self::REPORT_TOTAL_METRICS => array(self::METRIC_UNION_LIVE_MEETING_VIEW_TIME, self::METRIC_COMBINED_LIVE_ENGAGED_USERS_PLAY_TIME_RATIO, self::EVENT_TYPE_MEETING_RAISE_HAND, self::EVENT_TYPE_REACTION_CLICKED),
