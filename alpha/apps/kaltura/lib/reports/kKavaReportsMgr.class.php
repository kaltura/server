...
class kKavaReportsMgr extends kKavaBase
{
	...
	const METRIC_RECORDED_MSECS_ADDED = 'added_recording_msecs';
	const METRIC_RECORDED_MSECS_DELETED = 'deleted_recording_msecs';
	const METRIC_RECORDED_MSECS_TOTAL = 'total_recording_msecs';
	const METRIC_RECORDED_HOURS_ADDED = 'added_recording_hours';
	...
	protected static function init()
	{
		...
		$delta_metrics = array(
			...
			array(self::METRIC_DURATION_SEC, self::METRIC_RECORDED_MSECS_TOTAL, self::METRIC_RECORDED_MSECS_ADDED, self::METRIC_RECORDED_MSECS_DELETED,
		...
		self::$metrics_def[self::METRIC_RECORDED_HOURS_ADDED] = array(
			self::DRUID_AGGR => array(self::METRIC_RECORDED_MSECS_ADDED),
			self::DRUID_POST_AGGR => self::getConstantRatioPostAggr(
				self::METRIC_RECORDED_HOURS_ADDED, self::METRIC_RECORDED_MSECS_ADDED, '3600000'));
