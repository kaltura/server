...
class kKavaReportsMgr extends kKavaBase
{
	...
	const METRIC_AVG_COMPLETION_RATE = 'avg_completion_rate';
	...
	protected static $reports_def = array(
		myReportsMgr::REPORT_TYPE_TOP_CONTENT => array(
			...
			self::REPORT_METRICS => array(self::EVENT_TYPE_PLAY, self::METRIC_QUARTILE_PLAY_TIME, self::METRIC_AVG_PLAY_TIME, self::EVENT_TYPE_PLAYER_IMPRESSION, self::METRIC_PLAYER_IMPRESSION_RATIO, self::METRIC_AVG_DROP_OFF, self::METRIC_UNIQUE_USERS, self::METRIC_AVG_COMPLETION_RATE),
			self::REPORT_FORCE_TOTAL_COUNT => true,
			self::REPORT_GRAPH_METRICS => array(self::EVENT_TYPE_PLAY, self::METRIC_QUARTILE_PLAY_TIME, self::METRIC_AVG_PLAY_TIME, self::EVENT_TYPE_PLAYER_IMPRESSION, self::METRIC_AVG_COMPLETION_RATE),
		),
		...
		myReportsMgr::REPORT_TYPE_USER_TOP_CONTENT => array(
			...
			self::REPORT_METRICS => array(self::METRIC_UNIQUE_ENTRIES, self::EVENT_TYPE_PLAY, self::METRIC_QUARTILE_PLAY_TIME, self::METRIC_AVG_PLAY_TIME, self::METRIC_AVG_DROP_OFF, self::EVENT_TYPE_PLAYER_IMPRESSION, self::METRIC_PLAYER_IMPRESSION_RATIO, self::METRIC_AVG_COMPLETION_RATE),
			self::REPORT_GRAPH_METRICS => array(self::EVENT_TYPE_PLAY, self::METRIC_QUARTILE_PLAY_TIME, self::METRIC_AVG_PLAY_TIME, self::EVENT_TYPE_PLAYER_IMPRESSION, self::METRIC_UNIQUE_USERS, self::METRIC_AVG_DROP_OFF, self::METRIC_AVG_COMPLETION_RATE),
			self::REPORT_TOTAL_METRICS => array(self::METRIC_UNIQUE_USERS, self::METRIC_UNIQUE_ENTRIES, self::EVENT_TYPE_PLAY, self::METRIC_QUARTILE_PLAY_TIME, self::METRIC_AVG_PLAY_TIME, self::METRIC_AVG_DROP_OFF, self::EVENT_TYPE_PLAYER_IMPRESSION, self::METRIC_PLAYER_IMPRESSION_RATIO, self::METRIC_AVG_COMPLETION_RATE),
		),
	...
	protected static $metrics_to_headers = array(
		...
		self::METRIC_AVG_COMPLETION_RATE => self::METRIC_AVG_COMPLETION_RATE,
	...
	protected static $non_linear_metrics = array(
		...
		self::METRIC_AVG_COMPLETION_RATE => true,
	...
	protected static function init()
	{
		...
		self::$metrics_def[self::METRIC_AVG_COMPLETION_RATE] = array(
			self::DRUID_AGGR => array(self::EVENT_TYPE_PLAY, self::METRIC_UNIQUE_PERCENTILES_SUM),
			self::DRUID_POST_AGGR => self::getFieldRatioPostAggr(
				self::METRIC_AVG_COMPLETION_RATE,
