...
class kKavaReportsMgr extends kKavaBase
{
	...
	protected static function getTotalTableCount($partner_id, $report_def, reportsInputFilter $input_filter, $intervals, $druid_filter, $dimension, $object_ids = null, $response_options)
	{
