...
class kKavaCnCReports extends kKavaReportsMgr
{
	protected static $reports_def = array(
		...
		ReportType::CNC_PARTICIPATION => array(
			self::REPORT_METRICS => array(self::EVENT_TYPE_REACTION_CLICKED, self::METRIC_REACTION_CLICKED_PARTICIPATION, self::EVENT_TYPE_GROUP_MESSAGE_SENT, self::METRIC_GROUP_CHAT_PARTICIPATION, self::METRIC_POLL_PARTICIPATION, self::METRIC_Q_AND_A_PARTICIPATION, self::METRIC_Q_AND_A_THREADS_COUNT, self::METRIC_PRIVATE_CHAT_PARTICIPATION),
