...
class SystemUserFilter extends baseObjectFilter
{
	public function init ()
	{
		...
		$this->allowed_order_fields = array ( "id" , "status");
	...
	{
		$res = SystemUserPeer::translateFieldName( $field_name , $this->field_name_translation_type , BasePeer::TYPE_COLNAME );
		return $res;
	}

	public function getIdFromPeer (  )
	{
		return SystemUserPeer::ID;
	}
}
