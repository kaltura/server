...
kmc.functions = {
    ...
    openStudio: function(){
        //alert('opening studio! version='+kmc.vars.studio.version+", confid="+kmc.vars.studio.uiconf_id);
        kmc.utils.hideFlash(true);
        kmc.utils.openIframe(kmc.vars.base_url + '/apps/studio/' + kmc.vars.studio.version);
        //kmc.utils.setTab(go_to.moduleName, true);
        //kmc.mediator.writeUrlHash(go_to.moduleName, go_to.subtab);
        return false;
    },
