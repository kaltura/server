...
class DeliveryProfileLiveAppleHttpToMulticast extends DeliveryProfileLiveAppleHttp {
	...
	{
		list($primaryUrl, $backupUrl) = parent::getEdgeServerUrls($primaryUrl, $backupUrl);
		preg_replace('/' . EdgeServer::EDGE_SERVER_DEFAULT_LIVE_CACHE_APPLICATION_NAME . '/', EdgeServer::EDGE_SERVER_DEFAULT_LIVE_UNICAST_TO_MC_APPLICATION_NAME , $primaryUrl, 1);
