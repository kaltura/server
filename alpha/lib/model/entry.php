...
/**
	...
	public function getObjectParams($params = null)
	{
		$body = array(
			...
			'name' => explode(',', multiLingualUtils::getElasticFieldValue($this, self::NAME)),
			'description' => explode(',', multiLingualUtils::getElasticFieldValue($this, self::DESCRIPTION)),
			'tags' => explode(',', multiLingualUtils::getElasticFieldValue($this, self::TAGS)),
			'partner_id' => $this->getPartnerId(),
