...
class DeliveryProfileVodPackagerDash extends DeliveryProfileDash {
	...
	{
		if ($flavor && $this->getDynamicAttributes()->getHasValidSequence() && $flavor->getType() != assetType::FLAVOR)
			return null;
		return parent::getFlavorAssetInfo($url, $urlPrefix, $flavor); // TODO: Change the autogenerated stub
	}
