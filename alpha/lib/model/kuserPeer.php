...
{	
	...
	public static function createKuserForPartner($partner_id, $puser_id, $is_admin = false)
	{
		...
		return kLock::runLocked($lockKey, array('kuserPeer','getOrCreateKuserForPartner'), array($partner_id, $puser_id, $is_admin));
	}

	public static function getOrCreateKuserForPartner($partner_id, $puser_id, $is_admin = false)
	{
