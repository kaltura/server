...
/**
 * This class defines the structure of the 'server_node' table.
 *
 *
 *
 ...
 */
class ServerNodeTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Core.ServerNodeTableMap';
	...
	{
	  // attributes
		$this->setName('server_node');
		$this->setPhpName('ServerNode');
		$this->setClassname('ServerNode');
		...
		$this->addColumn('ENVIRONMENT', 'Environment', 'VARCHAR', false, 32, null);
