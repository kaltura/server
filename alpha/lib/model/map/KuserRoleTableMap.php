...
/**
 * This class defines the structure of the 'kuser_role' table.
 *
 *
 *
 ...
 */
class KuserRoleTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.KuserRoleTableMap';
	...
	{
	  // attributes
		$this->setName('kuser_role');
		$this->setPhpName('KuserRole');
		$this->setClassname('KuserRole');
