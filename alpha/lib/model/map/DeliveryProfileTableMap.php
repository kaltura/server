 ...
 */
class DeliveryProfileTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Core.DeliveryProfileTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPhpName('DeliveryProfile');
		$this->setClassname('DeliveryProfile');
