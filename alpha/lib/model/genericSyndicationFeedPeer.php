 ...
 * @subpackage model
 */ 
class genericSyndicationFeedPeer extends SyndicationFeedPeer
{
	/** the related Propel class for this table */
	const OM_CLASS = 'genericSyndicationFeed';
	
	/**
	 * @var genericSyndicationFeedPeer
	 */
	...
	{
		if(!self::$myInstance)
			self::$myInstance = new genericSyndicationFeedPeer();
			
		if(!self::$instance || !(self::$instance instanceof genericSyndicationFeedPeer))
