...
//		$cloned->setNew(true);
    ...
    {
        return $this->getFromCustomData("autoplay", null, false);
    }

    public function setAutoplay($v)
    {
        return $this->putInCustomData("autoplay", $v);
    }

    public function getAutomuted()
    {
        return $this->getFromCustomData("automuted", null, false);
    }

    public function setAutomuted($v)
    {
        return $this->putInCustomData("automuted", $v);
    }

    public function getConfFileVersion()
    {
        return $this->getFromCustomData(self::CUSTOM_DATA_CON_FILE_VERSION, null, 0);
    }

    public function setConfFileVersion($v)
    {
        return $this->putInCustomData(self::CUSTOM_DATA_CON_FILE_VERSION, $v);
    }

    public function getConfFileFeaturesVersion()
    {
        return $this->getFromCustomData(self::CUSTOM_DATA_CONF_FILE_FEATURES_VERSION, null, 0);
    }

    public function setConfFileFeaturesVersion($v)
    {
        return $this->putInCustomData(self::CUSTOM_DATA_CONF_FILE_FEATURES_VERSION, $v);
    }
