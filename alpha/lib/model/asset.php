...
class asset extends Baseasset implements ISyncableFile
{
	...
	*/
	...
	public function getExternalUrl($storageId, $fileName = null)
	{
		...
		$urlManager = DeliveryProfilePeer::getRemoteDeliveryByStorageId(DeliveryProfileDynamicAttributes::init($fileSync->getDc(), $this->getEntryId(), PlaybackProtocol::HTTP), $fileSync, $this);
