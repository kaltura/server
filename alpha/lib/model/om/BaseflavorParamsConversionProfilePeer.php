...
abstract class BaseflavorParamsConversionProfilePeer {
	...
	{
		return flavorParamsConversionProfilePeer::populateObjects(flavorParamsConversionProfilePeer::doSelectStmt($criteria, $con));
	}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj = flavorParamsConversionProfilePeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				flavorParamsConversionProfilePeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
