...
abstract class BaseentryPeer {
	...
	/** the column name for the CREATOR_PUSER_ID field */
	const CREATOR_PUSER_ID = 'entry.CREATOR_PUSER_ID';

	/** the column name for the ENTITLED_USERS_EDIT field */
	const ENTITLED_USERS_EDIT = 'entry.ENTITLED_USERS_EDIT';

	/** the column name for the ENTITLED_USERS_PUBLISH field */
	const ENTITLED_USERS_PUBLISH = 'entry.ENTITLED_USERS_PUBLISH';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(entryPeer::CREATOR_PUSER_ID);
		$criteria->addSelectColumn(entryPeer::ENTITLED_USERS_EDIT);
		$criteria->addSelectColumn(entryPeer::ENTITLED_USERS_PUBLISH);
	}
