...
/**
 * Base class that represents a row from the 'tagword_count' table.
 *
 * 
 *
...
abstract class BaseTagwordCount extends BaseObject  implements Persistent {
	 ...
	 * @return     TagwordCount The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->tag = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->tag_count = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = TagwordCountPeer::NUM_COLUMNS - TagwordCountPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TagwordCountPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				TagwordCountPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		TagwordCountPeer::setUseCriteriaFilter(false);
		$this->reload();
		TagwordCountPeer::setUseCriteriaFilter(true);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TagwordCount (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TagwordCount Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @var     TagwordCount Clone of current object.
	 */
	 ...
	 * Stores the source object that this object copied from 
	 *
	 * @param      TagwordCount $copiedFrom Clone of current object.
	 */
	public function setCopiedFrom(TagwordCount $copiedFrom)
	{
