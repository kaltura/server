...
abstract class BaseDropFolderPeer {
	...
	const CLASS_DEFAULT = 'Core.DropFolder';
	...
	/** the column name for the SLUG_FIELD field */
	const SLUG_FIELD = 'drop_folder.SLUG_FIELD';

	/** the column name for the SLUG_REGEX field */
	const SLUG_REGEX = 'drop_folder.SLUG_REGEX';
