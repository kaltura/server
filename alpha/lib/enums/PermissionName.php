...
interface PermissionName extends BaseEnum
{
    ...
    const FEATURE_COPY_THUMB_CUE_POINTS_TO_CLIP = 'FEATURE_COPY_THUMB_CUE_POINTS_TO_CLIP';
    const FEATURE_COPY_THUMB_CUE_POINTS_TO_TRIMMED_ENTRY = 'FEATURE_COPY_THUMB_CUE_POINTS_TO_TRIMMED_ENTRY';
    const FEATURE_COPY_ANNOTATIONS_TO_CLIP = 'FEATURE_COPY_ANNOTATIONS_TO_CLIP';
    const FEATURE_COPY_ANNOTATIONS_TO_TRIMMED_ENTRY = 'FEATURE_COPY_ANNOTATIONS_TO_TRIMMED_ENTRY';
    const FEATURE_COPY_AD_CUE_POINTS_TO_CLIP = 'FEATURE_COPY_AD_CUE_POINTS_TO_CLIP';
    const FEATURE_COPY_AD_CUE_POINTS_TO_TRIMMED_ENTRY = 'FEATURE_COPY_AD_CUE_POINTS_TO_TRIMMED_ENTRY';
    const FEATURE_COPY_CODE_CUE_POINTS_TO_CLIP = 'FEATURE_COPY_CODE_CUE_POINTS_TO_CLIP';
    const FEATURE_COPY_CODE_CUE_POINTS_TO_TRIMMED_ENTRY = 'FEATURE_COPY_CODE_CUE_POINTS_TO_TRIMMED_ENTRY';
