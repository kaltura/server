...
interface PermissionName extends BaseEnum
{
	...
	// new category permissions for the edge server 
	const EDGE_SERVER_BASE = 'EDGE_SERVER_BASE';
	const EDGE_SERVER_ADD = 'EDGE_SERVER_ADD';
	const EDGE_SERVER_UPDATE = 'EDGE_SERVERL_UPDATE';
	const EDGE_SERVER_DELETE = 'EDGE_SERVER_DELETE';
}
