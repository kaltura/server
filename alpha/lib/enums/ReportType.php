...
//	const ADMIN_CONSOLE = 10;		// shouldn't be accessable to users through the API
   ...
   //experience
   const QOE_EXPERIENCE_PLATFORMS = 30002;
   const QOE_EXPERIENCE_COUNTRY = 30003;
   const QOE_EXPERIENCE_REGION = 30004;
   const QOE_EXPERIENCE_CITY = 30005;
   const QOE_EXPERIENCE_BROWSERS_FAMILIES = 30006;
   const QOE_EXPERIENCE_BROWSERS = 30007;
   const QOE_EXPERIENCE_OPERATING_SYSTEM_FAMILIES = 30008;
   const QOE_EXPERIENCE_OPERATING_SYSTEM = 30009;
   const QOE_EXPERIENCE_PLAYER_VERSION = 30010;
   const QOE_EXPERIENCE_ENTRY = 30011;
   const QOE_EXPERIENCE_ISP = 30012;

   //engagement
   const QOE_ENGAGEMENT_PLATFORMS = 30013;
   const QOE_ENGAGEMENT_COUNTRY = 30014;
   const QOE_ENGAGEMENT_REGION = 30015;
   const QOE_ENGAGEMENT_CITY = 30016;
   const QOE_ENGAGEMENT_BROWSERS_FAMILIES = 30017;
   const QOE_ENGAGEMENT_BROWSERS = 30018;
   const QOE_ENGAGEMENT_OPERATING_SYSTEM_FAMILIES = 30019;
   const QOE_ENGAGEMENT_OPERATING_SYSTEM = 30020;
   const QOE_ENGAGEMENT_PLAYER_VERSION = 30021;
   const QOE_ENGAGEMENT_ENTRY = 30022;
   const QOE_ENGAGEMENT_ISP = 30023;

   const QOE_STREAM_QUALITY_PLATFORMS = 30024;
   const QOE_STREAM_QUALITY_COUNTRY = 30025;
   const QOE_STREAM_QUALITY_REGION = 30026;
   const QOE_STREAM_QUALITY_CITY = 30027;
   const QOE_STREAM_QUALITY_BROWSERS_FAMILIES = 30028;
   const QOE_STREAM_QUALITY_BROWSERS = 30029;
   const QOE_STREAM_QUALITY_OPERATING_SYSTEM_FAMILIES = 30030;
   const QOE_STREAM_QUALITY_OPERATING_SYSTEM = 30031;
   const QOE_STREAM_QUALITY_PLAYER_VERSION = 30032;
   const QOE_STREAM_QUALITY_ENTRY = 30033;
   const QOE_STREAM_QUALITY_ISP = 30034;
