...
interface permissionName extends BaseEnum
{
	...
	const BASE_ADMIN_KS_PERMISSION = 'BASE_ADMIN_KS_PERMISSION';
	const BASE_USER_KS_PERMISSION = 'BASE_USER_KS_PERMISSION';
	const NO_KS_PERMISSION = 'NO_KS_PERMISSION';
	const BASE_WIDGET_KS_PERMISSION = 'BASE_WIDGET_KS_PERMISSION';
	...
	const CONTENT_UPLOAD = 'CONTENT_UPLOAD';
	const CONTENT_BULK_UPLOAD = 'CONTENT_BULK_UPLOAD';
	...
	//const CONTENT_MANAGE_ANNOTATE = 'CONTENT_MANAGE_ANNOTATE';
