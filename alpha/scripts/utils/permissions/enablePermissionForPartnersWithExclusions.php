...
//	}
//	$c->add (PartnerPeer::PARTNER_PACKAGE, $accountTypesToExclude, Criteria::NOT_IN);
//	$c->addAscendingOrderByColumn ( PartnerPeer::ID );
//	$c->setLimit ( $countLimitEachLoop );
//	$partners = PartnerPeer::doSelect ( $c, $con );
//    if (!count($partners))
...
//	{
//		/* @var $partner partner */
//		if (!PermissionPeer::getByNamesAndPartner($permissionsToExclude, explode(',', $partner->getId())) &&
//			!in_array($partner->getId(), $partnersToExclude))
//		{
