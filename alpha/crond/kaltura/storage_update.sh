...
php /opt/kaltura/app/support_prod/test/dummy/findEntriesSizes.php $WHEN >> /var/log/`hostname`-findEntriesSizes.log
php /opt/kaltura/app/support_prod/test/dummy/findMediaStats.php $WHEN >> /var/log/`hostname`-findMediaStats.log
#not ready yet
...
php /opt/kaltura/app/alpha/batch/batchPartnerUsage.php >> /var/log/`hostname`-BatchPartnerUsage_upgradeProcess.log
