...
class KalturaErrors extends APIErrors
{
    ...
    */
	...
	const USER_ENTRY_ALREADY_EXISTS = 'USER_ENTRY_ALREADY_EXISTS;ENTRY_ID;A user-entry for the given user-id and entry-id [@ENTRY_ID@] already exists, cannot create duplicate';
