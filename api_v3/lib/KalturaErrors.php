...
class KalturaErrors extends APIErrors
{
	...
	const MAX_ALLOWED_SMALL_CHUNK_COUNT_EXCEEDED = "MAX_ALLOWED_SMALL_CHUNK_COUNT_EXCEEDED;;Exceeded Max allowed upload of small chunks less than 1048576 bytes";
