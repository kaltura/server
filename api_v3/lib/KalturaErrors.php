...
class KalturaErrors extends APIErrors
{
	...
	const ASSIGNING_INFO_TO_ENTRY_WITH_PARENT_IS_FORBIDDEN = "ASSIGNING_INFO_TO_ENTRY_WITH_PARENT_IS_FORBIDEN;ID;assigning categories|scheduling|access control to entry with parent entry \"@ID@\" is not allowed";
