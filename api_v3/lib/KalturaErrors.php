...
class KalturaErrors extends APIErrors
{
	...
	const MAX_FILE_SYNCS_FOR_OBJECT_PER_DAY_REACHED = "MAX_FILE_SYNCS_FOR_OBJECT_PER_DAY_REACHED;OBJECT_ID;Object ID \"@OBJECT_ID@\" not updated with latest chnages";
