...
class KalturaErrors extends APIErrors
{
	 ...
	 *
	 */
	const CANNOT_RETRIEVE_ANOTHER_USER_USING_NON_ADMIN_SESSION = "CANNOT_RETRIEVE_ANOTHER_USER_USING_NON_ADMIN_SESSION;USER_ID;cannot another admin user \"@USER_ID@\" using non-admin session";
