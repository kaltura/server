...
abstract class KalturaPermissionItemBaseFilter extends KalturaFilter
{
	...
	{
		return array_merge(parent::getMapBetweenObjects(), KalturaPermissionItemBaseFilter::$map_between_objects);
	}

	public function getOrderByMap()
	{
		return array_merge(parent::getOrderByMap(), KalturaPermissionItemBaseFilter::$order_by_map);
	}
