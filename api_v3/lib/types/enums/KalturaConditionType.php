...
class KalturaConditionType extends KalturaDynamicEnum implements ConditionType
{
	...
	public static function getDescriptions()
	{
		$descriptions = array(
			...
			ConditionType::VALIDATE_ACTION_NAME => 'Validate that request is for a desired service and action',
			ConditionType::VALIDATE_AUTHENTICATION_TYPES => 'Validate authentication types on url request',
			);
