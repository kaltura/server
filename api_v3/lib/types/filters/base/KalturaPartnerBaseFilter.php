...
abstract class KalturaPartnerBaseFilter extends KalturaFilter
{
	...
	{
		return array_merge(parent::getMapBetweenObjects(), KalturaPartnerBaseFilter::$map_between_objects);
	}

	public function getOrderByMap()
	{
		return array_merge(parent::getOrderByMap(), KalturaPartnerBaseFilter::$order_by_map);
	}
