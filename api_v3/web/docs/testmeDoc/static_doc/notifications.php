...
<p>  
The following notifications modes are supported and could be configured by partners at their account settings page within <a href="../../index.php/kmc" target="_blank">Kaltura Management console</a>:
</p>
<ul>
	<li>
...
<p>
The following table summarizes the different notification types and the parameters that are being included within each notification. For more information on the possible types of notifications is please review the <a href="#" onclick="KDoc.openObject('KalturaNotificationType')">KalturaNotificationType</a> documentation page.
</p>
