...
phpdoc -o HTML:frames:phpedit -t ..\batch -ti "Kaltura Server" -dn General -dc Global -ct readonly,insertonly,writeonly,service,action,clientgenerator,filter,serverOnly,dynamicType,requiresPermission -d ../../batch,../../infra,../../plugins -po General,api,Core,plugins*
