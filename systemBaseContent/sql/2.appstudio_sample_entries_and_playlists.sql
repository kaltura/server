...
("0","4","_KMCLOGO2",2,"1","1","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/data/kaltura_logo_animated_blue.flv","2743980"),
("0","4","_KMCLOGO3",2,"1","1","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/data/kaltura_logo_animated_green.flv","2615388"),
("0","4","_KMCLOGO4",2,"1","1","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/data/kaltura_logo_animated_pink.flv","2490304"),
("0","4","_KMCLOGO5",2,"1","1","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/data/kaltura_logo_animated_red.flv","2966138"),
("0","4","_KMCLOGO1",2,"1","1","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/data/kaltura_logo_animated_black.flv","2898373"),
("0","1","_KMCLOGO",2,"100000","3","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/thumbnail/kmc_logo.jpg","36676"),
("0","1","_KMCLOGO2",2,"100000","3","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/thumbnail/kaltura_logo_animated_blue.jpg","18463"),
("0","1","_KMCLOGO3",2,"100000","3","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/thumbnail/kaltura_logo_animated_green.jpg","17572"),
("0","1","_KMCLOGO4",2,"100000","3","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/thumbnail/kaltura_logo_animated_pink.jpg","16985"),
("0","1","_KMCLOGO5",2,"100000","3","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/thumbnail/kaltura_logo_animated_red.jpg","19930"),
("0","1","_KMCLOGO1",2,"100000","3","0","1",NOW(),NOW(),NOW(),"/web","/content/templates/entry/thumbnail/kaltura_logo_animated_black.jpg","19521"
);
...
# FOLLOWING ONLY RELEVANT FOR app-studio 2.X AND UP.

# playlist - first command in bash - create playlist file
#echo "_KMCLOGO1,_KMCLOGO5,_KMCLOGO2,_KMCLOGO4,_KMCLOGO3" > /web/content/templates/entry/data/kmc_template_playlist1.txt
#select "_KMCLOGO1,_KMCLOGO5,_KMCLOGO2,_KMCLOGO4,_KMCLOGO3" into outfile "/web/content/templates/entry/data/kmc_template_playlist1.txt";
#echo "_KMCLOGO4,_KMCLOGO3,_KMCLOGO5,_KMCLOGO1,_KMCLOGO2" > /web/content/templates/entry/data/kmc_template_playlist2.txt
#select "_KMCLOGO4,_KMCLOGO3,_KMCLOGO5,_KMCLOGO1,_KMCLOGO2" into outfile "/web/content/templates/entry/data/kmc_template_playlist2.txt";
...
(0,1,'_KMCSPL1','100000',1,'0',1,now(),now(),now(),NULL,2,1,NULL,NULL,'/web/','/content/templates/entry/data/kmc_template_playlist1.txt',49),
(0,1,'_KMCSPL1','100000',1,'1',0,now(),now(),NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),
(0,1,'_KMCSPL2','100000',1,'0',1,now(),now(),now(),NULL,2,1,NULL,NULL,'/web/','/content/templates/entry/data/kmc_template_playlist2.txt',49),
