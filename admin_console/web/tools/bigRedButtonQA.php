...
<head>
	...
	<script>
		...
		function onSyncPoint(metadata){
			...
			$('#btnSendAdTimestamp').removeAttr('disabled');
...
<div id="main" style="position: static;">
	...
	<table>
		...
		<tr>
			...
			<td><input type="text" id="txtAdDelay" value="300000" />
			<td colspan="2">
				<input id="btnSendAdTimestamp" type="button" onclick="sendAdTimestamp()" disabled="disabled" value="Big Red Button (Abs time)" style="background-color: red; height: 50px; font-size: 15pt;" />
			</td>
		</tr>
		<tr>
			<td colspan="2"><br/><br/></td>
