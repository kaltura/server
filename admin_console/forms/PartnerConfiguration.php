...
//--------------------------- Publisher specific Delivery Settings ---------------------------
		...
		$this->addElement('checkbox', 'checkbox_cdn_api_host', array(
			'decorators' => array('ViewHelper', array('Label', array('placement' => 'append')), array('HtmlTag',  array('tag' => 'dt', 'class' => 'partner_configuration_checkbox_field')))
		));

		$this->addElement('text', 'cdn_api_host', array(
			'label'			=> 'CDN Api Host:',
			'filters'		=> array('StringTrim'),
		));

		$this->addElement('checkbox', 'checkbox_cdn_api_host_https', array(
			'decorators' => array('ViewHelper', array('Label', array('placement' => 'append')), array('HtmlTag',  array('tag' => 'dt', 'class' => 'partner_configuration_checkbox_field')))
		));

		$this->addElement('text', 'cdn_api_host_https', array(
			'label'			=> 'CDN Api Host Https:',
			'filters'		=> array('StringTrim'),
		));
