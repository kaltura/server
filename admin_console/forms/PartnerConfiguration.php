...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------		
	...
	public function addAllDisplayGroups($permissionNames)
	{
		...
		$this->addDisplayGroup(array_merge(array('def_thumb_offset') , $permissionNames[self::GROUP_CONTENT_INGESTION_OPTIONS], array('def_thumb_density', 'enable_bulk_upload_notifications_emails', 'bulk_upload_notifications_email', 'crossLine')), 'publisherSpecificIngestionSettings', array('legend' => 'Content Ingestion Options'));
