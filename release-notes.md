...
#### Deployment Scripts ####
	...
	(developer's responsibility) php /opt/kaltura/app/alpha/scripts/utils/permissions/enablePermissionForPartner.php {PID} VOICEBASE_PLUGIN_PERMISSION 2 realrun
