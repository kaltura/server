...
abstract class KalturaVirusScanProfileBaseFilter extends KalturaFilter
{
	...
	{
		return array_merge(parent::getMapBetweenObjects(), KalturaVirusScanProfileBaseFilter::$map_between_objects);
	}

	public function getOrderByMap()
	{
		return array_merge(parent::getOrderByMap(), KalturaVirusScanProfileBaseFilter::$order_by_map);
	}
