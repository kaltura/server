...
abstract class BaseVirusScanProfilePeer {
	...
	const CLASS_DEFAULT = 'lib.model.VirusScanProfile';
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$stmt = VirusScanProfilePeer::doCountStmt($criteria, $con);
	...
	{
		return VirusScanProfilePeer::populateObjects(VirusScanProfilePeer::doSelectStmt($criteria, $con));
	}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj = VirusScanProfilePeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				VirusScanProfilePeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
