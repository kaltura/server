<?php
/**
 * Enable event notifications on virtual event objects
 * @package plugins.virtualEventEventNotifications
 */
class VirtualEventEventNotificationsPlugin extends KalturaPlugin implements IKalturaPending, IKalturaEnumerator, IKalturaObjectLoader
{
	const PLUGIN_NAME = 'virtualEventEventNotifications';
	
	const  VIRTUAL_EVENT_PLUGIN_NAME = 'virtualEvent';
	...
	public static function dependsOn()
	{
		...
		$virtualEventtDependency = new KalturaDependency(self:: VIRTUAL_EVENT_PLUGIN_NAME);
		$eventNotificationDependency = new KalturaDependency(self::EVENT_NOTIFICATION_PLUGIN_NAME, $eventNotificationVersion);
		
		return array( $virtualEventtDependency, $eventNotificationDependency);
	}
	...
	public static function getEnums($baseEnumName = null)
	{
		if(is_null($baseEnumName))
			return array('VirtualEventEventNotificationEventObjectType');
