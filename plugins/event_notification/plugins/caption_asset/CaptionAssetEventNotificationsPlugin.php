 ...
 */
class CaptionAssetEventNotificationsPlugin extends KalturaPlugin implements IKalturaPending, IKalturaEnumerator, IKalturaObjectLoader
{
	...
	public static function dependsOn()
	{
		...
		$captionAssetDependency = new KalturaDependency(self::CAPTION_ASSET_PLUGIN_NAME);
