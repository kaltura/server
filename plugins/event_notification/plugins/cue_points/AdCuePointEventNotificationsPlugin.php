 ...
 */
class AdCuePointEventNotificationsPlugin extends KalturaPlugin implements IKalturaPending, IKalturaEnumerator, IKalturaObjectLoader
{
	...
	public static function dependsOn()
	{
		...
		$adCuePointDependency = new KalturaDependency(self::AD_CUE_POINT_PLUGIN_NAME);
