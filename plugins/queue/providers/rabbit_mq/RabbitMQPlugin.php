<?php
	 ...
	 */
	class RabbitMQPlugin extends KalturaPlugin implements IKalturaPending, IKalturaObjectLoader, IKalturaQueuePlugin, IKalturaEnumerator
	{
		...
		public static function getEnums($baseEnumName = null)
		{
			if (is_null($baseEnumName))
				return array('RabbitMQProviderType');
