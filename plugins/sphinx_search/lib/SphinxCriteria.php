...
abstract class SphinxCriteria extends KalturaCriteria implements IKalturaIndexQuery
{
	...
	public function applyFilters()
	{
		...
		if(!$this->hasAdvancedSearchFilter && !count($this->matchClause) && !count($this->conditionClause) && $this->shouldSkipSphinx() && !isset($this->groupByColumn) && !isset($this->selectColumn))
		{
