...
abstract class BaseSphinxLogPeer {
	...
	const CLASS_DEFAULT = 'lib.model.SphinxLog';
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$stmt = SphinxLogPeer::doCountStmt($criteria, $con);
	...
	{
		return SphinxLogPeer::populateObjects(SphinxLogPeer::doSelectStmt($criteria, $con));
	}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj = SphinxLogPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				SphinxLogPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	public static function doCountJoinPartner(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SphinxLogPeer::PARTNER_ID, PartnerPeer::ID, $join_behavior);
	...
	public static function doCountJoinentry(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SphinxLogPeer::ENTRY_ID, entryPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of SphinxLog objects pre-filled with their Partner objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of SphinxLog objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPartner(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SphinxLogPeer::addSelectColumns($criteria);
		$startcol = (SphinxLogPeer::NUM_COLUMNS - SphinxLogPeer::NUM_LAZY_LOAD_COLUMNS);
		PartnerPeer::addSelectColumns($criteria);

		$criteria->addJoin(SphinxLogPeer::PARTNER_ID, PartnerPeer::ID, $join_behavior);

		$stmt = SphinxLogPeer::doSelectStmt($criteria, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = SphinxLogPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = SphinxLogPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				SphinxLogPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SphinxLog) to $obj2 (Partner)
				$obj2->addSphinxLog($obj1);
	...
	/**
	 * Selects a collection of SphinxLog objects pre-filled with their entry objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of SphinxLog objects.
	...
	public static function doSelectJoinentry(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SphinxLog) to $obj2 (entry)
				$obj2->addSphinxLog($obj1);
	...
	/**
	 * Selects a collection of SphinxLog objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SphinxLogPeer::addSelectColumns($criteria);
		$startcol2 = (SphinxLogPeer::NUM_COLUMNS - SphinxLogPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SphinxLog) to the collection in $obj2 (Partner)
				$obj2->addSphinxLog($obj1);
          ...
          $cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);
				...
				// Add the $obj1 (SphinxLog) to the collection in $obj3 (entry)
				$obj3->addSphinxLog($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of SphinxLog objects pre-filled with all related objects except Partner.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptPartner(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);
				...
				// Add the $obj1 (SphinxLog) to the collection in $obj2 (entry)
				$obj2->addSphinxLog($obj1);
	...
	/**
	 * Selects a collection of SphinxLog objects pre-filled with all related objects except entry.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
