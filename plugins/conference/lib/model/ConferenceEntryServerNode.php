...
class ConferenceEntryServerNode extends EntryServerNode
{
	...
	{
		$this->addTrackEntryInfo(null, "serverNodeId=".$this->getServerNodeId().":action=Allocated");
		parent::postInsert($con); // TODO: Change the autogenerated stub
	}

	public function postDelete(PropelPDO $con = null)
	{
		$this->addTrackEntryInfo(null, "serverNodeId=".$this->getServerNodeId().":action=Released");
