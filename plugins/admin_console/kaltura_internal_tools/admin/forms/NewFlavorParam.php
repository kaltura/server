...
class Form_NewFlavorParam extends Infra_Form
{
    public function init()
    {
        ...
        $this->addElement('text', 'extra_params', array(
            'label' => 'Extra engine params:',
            'required' => true,
            'filters' => array('StringTrim'),
            'validators' => array()
        ));

        $this->addElement('text', 'conversion_engines', array(
            'label' => 'Conversion engines:',
            'required' => true,
            'filters' => array('StringTrim'),
            'validators' => array()
        ));

        $this->addElements(array(new Kaltura_Form_Element_EnumSelect('video_codec', array('enum' => 'Kaltura_Client_Enum_VideoCodec')),
