...
abstract class BaseMetadataProfilePeer {
	...
	const CLASS_DEFAULT = 'lib.model.MetadataProfile';
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$stmt = MetadataProfilePeer::doCountStmt($criteria, $con);
	...
	{
		return MetadataProfilePeer::populateObjects(MetadataProfilePeer::doSelectStmt($criteria, $con));
	}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj = MetadataProfilePeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				MetadataProfilePeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
