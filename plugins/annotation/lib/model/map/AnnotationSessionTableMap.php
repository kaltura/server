...
/**
 * This class defines the structure of the 'annotation_session' table.
 *
 *
 *
 ...
 */
class AnnotationSessionTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AnnotationSessionTableMap';
	...
	{
	  // attributes
		$this->setName('annotation_session');
		$this->setPhpName('AnnotationSession');
		$this->setClassname('AnnotationSession');
