...
abstract class BaseAnnotationPeer {
	...
	public static function updateInstancePool(&$queryResult)
	{
		...
		{
			$objFromPool = AnnotationPeer::getInstanceFromPool($curObject->getPrimaryKey());
			if ($objFromPool === null)
			{
				AnnotationPeer::addInstanceToPool($curObject);
			}
			else
			{
	...
	public static function addInstancesToPool($queryResult)
	{
		...
		{
			AnnotationPeer::addInstanceToPool($curResult);
		}
	}
	...
	{		
		$criteria = AnnotationPeer::prepareCriteriaForSelect($criteria);
		...
		if ($cachedResult !== null)
		{
			AnnotationPeer::filterSelectResults($cachedResult);
			AnnotationPeer::updateInstancePool($cachedResult);
			return $cachedResult;
		}

		$con = AnnotationPeer::alternativeCon($con);
		
		$queryResult = AnnotationPeer::populateObjects(BasePeer::doSelect($criteria, $con));
		...
		AnnotationPeer::filterSelectResults($queryResult);
		AnnotationPeer::addInstancesToPool($queryResult);
		return $queryResult;
	}
