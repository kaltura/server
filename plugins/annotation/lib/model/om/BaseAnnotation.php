...
abstract class BaseAnnotation extends BaseObject  implements Persistent {
	...
	{
		if(!isset($this->oldColumnsValues[AnnotationPeer::INT_ID]))
			$this->oldColumnsValues[AnnotationPeer::INT_ID] = $this->int_id;
		...
		if ($this->int_id !== $v) {
			$this->int_id = $v;
			$this->modifiedColumns[] = AnnotationPeer::INT_ID;
		}
	...
	{
		if(!isset($this->oldColumnsValues[AnnotationPeer::ID]))
			$this->oldColumnsValues[AnnotationPeer::ID] = $this->id;
	...
	{
		if(!isset($this->oldColumnsValues[AnnotationPeer::ENTRY_ID]))
			$this->oldColumnsValues[AnnotationPeer::ENTRY_ID] = $this->entry_id;
		...
		if ($this->entry_id !== $v) {
			$this->entry_id = $v;
			$this->modifiedColumns[] = AnnotationPeer::ENTRY_ID;
		}
	...
	{
		if(!isset($this->oldColumnsValues[AnnotationPeer::PARTNER_ID]))
			$this->oldColumnsValues[AnnotationPeer::PARTNER_ID] = $this->partner_id;
		...
		if ($this->partner_id !== $v) {
			$this->partner_id = $v;
			$this->modifiedColumns[] = AnnotationPeer::PARTNER_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = AnnotationPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = AnnotationPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	{
		if(!isset($this->oldColumnsValues[AnnotationPeer::STATUS]))
			$this->oldColumnsValues[AnnotationPeer::STATUS] = $this->status;
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = AnnotationPeer::STATUS;
		}
	...
	{
		if(!isset($this->oldColumnsValues[AnnotationPeer::KUSER_ID]))
			$this->oldColumnsValues[AnnotationPeer::KUSER_ID] = $this->kuser_id;
		...
		if ($this->kuser_id !== $v) {
			$this->kuser_id = $v;
			$this->modifiedColumns[] = AnnotationPeer::KUSER_ID;
		}
	 ...
	 *
	 * @var     Annotation Clone of current object.
	 */
	 ...
	 * Stores the source object that this object copied from 
	 *
	 * @param      Annotation $copiedFrom Clone of current object.
	 */
	public function setCopiedFrom(Annotation $copiedFrom)
	{
