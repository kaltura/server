...
class KalturaVirtualEventErrors extends KalturaErrors
{
	...
	const VIRTUAL_EVENT_INVALID_REGISTRATION_FORM_SCHEMA = "VIRTUAL_EVENT_INVALID_REGISTRATION_FORM_SCHEMA;;Registration Form Schema must be a valid json string";
}
