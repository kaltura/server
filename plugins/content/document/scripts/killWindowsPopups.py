...
CONFIG = [
    ...
    ('text:Microsoft Word/text:Static: Your margins are pretty small. Some of your content might be cut off when you print. Do you still want to print?',  0, None, (ET_PUSH_BUTTON, 'text:Yes,class:Button')),
