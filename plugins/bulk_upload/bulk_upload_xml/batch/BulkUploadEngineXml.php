...
class BulkUploadEngineXml extends KBulkUploadEngine
{
	 ...
	 */
	public function handleBulkUpload(KalturaBatchJob $job, KalturaBulkUploadXmlJobData $data) 
	{
		//Add XML logic here
	 ...
	 */
	protected function validate(KalturaBatchJob $job, KalturaBulkUploadXmlJobData $data) 
	{
		$xmlFilePath =$job->$filePath;
