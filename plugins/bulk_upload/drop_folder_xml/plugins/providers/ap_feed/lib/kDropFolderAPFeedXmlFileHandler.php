 ...
 * @subpackage model
 */
class kDropFolderAPFeedXmlFileHandler extends kDropFolderXmlFileHandler
{
    ...
    {
        return BulkUploadXmlPlugin::getBulkUploadTypeCoreValue(DropFolderXmlBulkUploadType::DROP_FOLDER_XML);
    }
