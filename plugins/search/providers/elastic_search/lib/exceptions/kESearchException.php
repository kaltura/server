...
class kESearchException extends kCoreException
{
	...
	const INVALID_CAPTION_ACCURACY_VALUES_NOT_IN_RANGE = "INVALID_CAPTION_ACCURACY_VALUES_NOT_IN_RANGE;FIELD;Range value for \"@FIELD@\" is illegal: Values must be between 0-100";
