...
class KalturaESearchErrors extends KalturaErrors
{
	...
	const MISSING_MANDATORY_SCORE_FUNCTION_PARAM = 'MISSING_MANDATORY_SCORE_FUNCTION_PARAM;;Missing mandatory score function parameter';
	const INVALID_SCORE_FUNCTION_FIELD_VALUE = 'INVALID_SCORE_FUNCTION_FIELD_VALUE;FIELD_NAME;Invalid [@FIELD_NAME@] value in score function';
}
