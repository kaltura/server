...
class KalturaESearchErrors extends KalturaErrors
{
	...
	const INVALID_FUNCTION_VALUE_IN_BOOST_SCORE_FUNCTION = 'INVALID_FUNCTION_VALUE_IN_BOOST_SCORE_FUNCTION;;Invalid FUNCTION TYPEvalue in boost score function';
	const INVALID_WEIGHT_VALUE_IN_BOOST_SCORE_FUNCTION = 'INVALID_WEIGHT_VALUE_IN_BOOST_SCORE_FUNCTION;;Invalid WEIGHT value in boost score function';
