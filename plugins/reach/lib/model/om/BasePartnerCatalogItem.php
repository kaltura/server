...
abstract class BasePartnerCatalogItem extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the vendor_catalog_item_id field.
	 * @var        int
	 */
	protected $vendor_catalog_item_id;
	...
	/**
	 * Get the [vendor_catalog_item_id] column value.
	 * 
	 * @return     int
	 */
	public function getVendorCatalogItemId()
	{
		return $this->vendor_catalog_item_id;
	}
	...
	/**
	 * Set the value of [vendor_catalog_item_id] column.
	 * 
	 * @param      int $v new value
	 * @return     PartnerCatalogItem The current object (for fluent API support)
	 */
	public function setVendorCatalogItemId($v)
	{
		if(!isset($this->oldColumnsValues[PartnerCatalogItemPeer::VENDOR_CATALOG_ITEM_ID]))
			$this->oldColumnsValues[PartnerCatalogItemPeer::VENDOR_CATALOG_ITEM_ID] = $this->vendor_catalog_item_id;

		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->vendor_catalog_item_id !== $v) {
			$this->vendor_catalog_item_id = $v;
			$this->modifiedColumns[] = PartnerCatalogItemPeer::VENDOR_CATALOG_ITEM_ID;
		}

		return $this;
	} // setVendorCatalogItemId()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->vendor_catalog_item_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = PartnerCatalogItemPeer::NUM_COLUMNS - PartnerCatalogItemPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				return $this->getVendorCatalogItemId();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getVendorCatalogItemId(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 3:
				...
				break;
			case 4:
				$this->setVendorCatalogItemId($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setVendorCatalogItemId($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PartnerCatalogItemPeer::VENDOR_CATALOG_ITEM_ID)) $criteria->add(PartnerCatalogItemPeer::VENDOR_CATALOG_ITEM_ID, $this->vendor_catalog_item_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setVendorCatalogItemId($this->vendor_catalog_item_id);
