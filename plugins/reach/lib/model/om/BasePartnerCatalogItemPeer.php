...
abstract class BasePartnerCatalogItemPeer {
	...
	/** the column name for the VENDOR_CATALOG_ITEM_ID field */
	const VENDOR_CATALOG_ITEM_ID = 'partner_catalog_item.VENDOR_CATALOG_ITEM_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PartnerId', 'CreatedAt', 'Status', 'VendorCatalogItemId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'partnerId', 'createdAt', 'status', 'vendorCatalogItemId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARTNER_ID, self::CREATED_AT, self::STATUS, self::VENDOR_CATALOG_ITEM_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'partner_id', 'created_at', 'status', 'vendor_catalog_item_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PartnerId' => 1, 'CreatedAt' => 2, 'Status' => 3, 'VendorCatalogItemId' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'partnerId' => 1, 'createdAt' => 2, 'status' => 3, 'vendorCatalogItemId' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARTNER_ID => 1, self::CREATED_AT => 2, self::STATUS => 3, self::VENDOR_CATALOG_ITEM_ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'partner_id' => 1, 'created_at' => 2, 'status' => 3, 'vendor_catalog_item_id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PartnerCatalogItemPeer::VENDOR_CATALOG_ITEM_ID);
	}
