...
class Form_DoubleClickProfileConfiguration extends Form_ConfigurableProfileConfiguration
{
	...
	public function renderFeedUrl($content)
	{
		...
		if (!$url)
			...
			return '<a href="'.$url.'" target="_blank">Feed URL</a> <a href="'.$url.'&period=86400" target="_blank">Last 24 Hours Feed URL</a> <a href="'.$url.'&version=2" target="_blank">24 Hour Feed (v2)</a>';
	}
}