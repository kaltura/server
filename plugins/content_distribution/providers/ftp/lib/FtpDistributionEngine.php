	...
	IDistributionEngineDelete
{
	...
	protected function getFileTransferManager(KalturaFtpDistributionProfile $distributionProfile)
	{
		...
		if ($protocol == KalturaDistributionProtocol::SFTP || $protocol == KalturaDistributionProtocol::SFTP_CMD || $protocol == KalturaDistributionProtocol::SFTP_SEC_LIB){
       		$publicKey = $distributionProfile->sftpPublicKey ;
        	$privateKey = $distributionProfile->sftpPrivateKey ;
		}
		else if ($protocol == KalturaDistributionProtocol::ASPERA){
