...
class ComcastDistributionProfile extends DistributionProfile
{
	...
	const CUSTOM_DATA_CATEGORY = 'category';
	...
	const METADATA_FIELD_RATING = 'Rating';
//	const METADATA_FIELD_CATEGORY = 'ComcastCategory';
	...
	public function getCategory()				{return $this->getFromCustomData(self::CUSTOM_DATA_CATEGORY);}
	...
	public function setCategory($v)				{$this->putInCustomData(self::CUSTOM_DATA_CATEGORY, $v);}
