 ...
 * @subpackage lib
 */
class FacebookDistributionProvider extends ConfigurableDistributionProvider
{
	/**
	 * @var FacebookDistributionProvider
	 */
	...
	/**
	 * @return FacebookDistributionProvider
	 */
	public static function get()
	{
		if(!self::$instance)
			self::$instance = new FacebookDistributionProvider();
	...
	{
		return FacebookDistributionPlugin::getDistributionProviderTypeCoreValue(FacebookDistributionProviderType::FACEBOOK);
	}
