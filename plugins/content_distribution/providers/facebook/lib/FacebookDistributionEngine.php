	...
	*/
	...
	private function convertToFacebookData($fieldValues, $isSubmit=false)
	{
		...
		if ($isSubmit) // these fields should not update
		{
			...
			$this->insertTargetingFacebookMetadata($feedTargetingMetadata, 'locales', $fieldValues[FacebookDistributionField::FEED_TARGETING_INTERESTED_IN], true);
			$this->insertTargetingFacebookMetadata($feedTargetingMetadata, 'locales', $fieldValues[FacebookDistributionField::FEED_TARGETING_EDUCATION_STATUSES], true);
			$this->insertTargetingFacebookMetadata($feedTargetingMetadata, 'locales', $fieldValues[FacebookDistributionField::FEED_TARGETING_RELATIONSHIP_STATUSES], true);
			$this->insertTargetingFacebookMetadata($feedTargetingMetadata, 'locales', $fieldValues[FacebookDistributionField::FEED_TARGETING_COLLEGE_YEARS], true);
			$this->insertTargetingFacebookMetadata($feedTargetingMetadata, 'locales', $fieldValues[FacebookDistributionField::FEED_TARGETING_INTERESTS], true);
			$this->insertTargetingFacebookMetadata($feedTargetingMetadata, 'locales', $fieldValues[FacebookDistributionField::FEED_TARGETING_RELEVANT_UNTIL], false);
