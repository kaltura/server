...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="CONST_WIDEVINE_MANIFEST_SUFFIX" select="'/format/widevine/tags/widevine/protocol/http/f/a.wvm'"/>
    <xsl:variable name="CONST_WIDEVINE_MBR_MANIFEST_SUFFIX" select="'/format/widevine/tags/widevine_mbr/protocol/http/f/a.wvm'"/>
    <!-- media element -->
