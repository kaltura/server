...
// 				'ingest',
// 				array('legend' => 'Ingest URL Configuration', 'decorators' => array('FormElements', 'Fieldset'))
// 		);
...
// 		// General
// 		$this->addElement('text', 'broadcaster_name', array(
// 				'label'			=> 'Broadcaster:',
// 				'filters'		=> array('StringTrim'),
// 				'order' => $order++,
// 		));
...
// // 		$this->getElement('publisher')->setLabel('Publisher:');
...
// 		$this->addDisplayGroup(
// 				array('publisher', 'ingest_url'),
// 				'ingest',
// 				array('legend' => 'Ingest URL Configuration', 'decorators' => array('FormElements', 'Fieldset'), 'order' => $order++)
// 		);
...
// 		// <feed>
// 		$this->addDisplayGroup(
// 			array('publisher', 'owner_name', 'notification_email', 'strict'),
// 			'feed_group',
