 ...
 * @subpackage lib
 */
class AvnDistributionProvider implements IDistributionProvider
{
	/**
	 * @var AvnDistributionProvider
	 */
	...
	/**
	 * @return AvnDistributionProvider
	 */
	public static function get()
	{
		if(!self::$instance)
			self::$instance = new AvnDistributionProvider();
