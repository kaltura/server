 ...
 * @subpackage lib
 */
class TimeWarnerDistributionProvider extends ConfigurableDistributionProvider
{
	/**
	 * @var TimeWarnerDistributionProvider
	 */
	...
	/**
	 * @return TimeWarnerDistributionProvider
	 */
	public static function get()
	{
		if(!self::$instance)
			self::$instance = new TimeWarnerDistributionProvider();
	...
	{
		return TimeWarnerDistributionPlugin::getDistributionProviderTypeCoreValue(TimeWarnerDistributionProviderType::TIME_WARNER);
	}
