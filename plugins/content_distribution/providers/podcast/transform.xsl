	...
	<rss xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" version="2.0">
		<xsl:for-each select="rss">
		   <channel>
				...
				<link>Put here your kaltura podcast url</link>
				...
				<itunes:image href="link to podcast image" />
				<itunes:category text="Category name can be nested for multiple categories">
					<itunes:category text="Second Category"/>
				</itunes:category>
