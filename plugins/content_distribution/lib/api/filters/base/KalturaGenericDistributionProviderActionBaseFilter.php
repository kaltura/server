...
abstract class KalturaGenericDistributionProviderActionBaseFilter extends KalturaFilter
{
	...
	{
		return array_merge(parent::getMapBetweenObjects(), KalturaGenericDistributionProviderActionBaseFilter::$map_between_objects);
	}

	public function getOrderByMap()
	{
		return array_merge(parent::getOrderByMap(), KalturaGenericDistributionProviderActionBaseFilter::$order_by_map);
	}
