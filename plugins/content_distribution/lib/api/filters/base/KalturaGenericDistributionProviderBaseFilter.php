...
abstract class KalturaGenericDistributionProviderBaseFilter extends KalturaDistributionProviderFilter
{
	...
	{
		return array_merge(parent::getMapBetweenObjects(), KalturaGenericDistributionProviderBaseFilter::$map_between_objects);
	}

	public function getOrderByMap()
	{
		return array_merge(parent::getOrderByMap(), KalturaGenericDistributionProviderBaseFilter::$order_by_map);
	}
