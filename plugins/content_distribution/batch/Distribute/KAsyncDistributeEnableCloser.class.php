...
class KAsyncDistributeEnableCloser extends KAsyncDistributeCloser
{
	...
	{
		return $this->kClient->contentDistributionBatch->getExclusiveAlmostDoneDistributionEnableJobs($this->getExclusiveLockKey(), $this->taskConfig->maximumExecutionTime, $this->taskConfig->maxJobsEachRun, $this->getFilter());
	}
