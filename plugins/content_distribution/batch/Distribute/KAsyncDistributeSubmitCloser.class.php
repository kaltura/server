...
class KAsyncDistributeSubmitCloser extends KAsyncDistributeCloser
{
	...
	{
		return $this->kClient->contentDistributionBatch->getExclusiveAlmostDoneDistributionSubmitJobs($this->getExclusiveLockKey(), $this->taskConfig->maximumExecutionTime, $this->taskConfig->maxJobsEachRun, $this->getFilter());
	}
	...
	{
		return DistributionEngine::getEngine('IDistributionEngineCloseSubmit', $providerType);
	}
