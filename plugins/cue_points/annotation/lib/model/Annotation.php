...
class Annotation extends CuePoint implements IMetadataObject
{
	...
	{
		return $entry->shouldCloneByProperty(AnnotationPlugin::getBaseEntryCloneOptionsCoreValue( BaseEntryAnnotationCuePointCloneOptions::ANNOTATION_CUE_POINTS), false);
	}
}
