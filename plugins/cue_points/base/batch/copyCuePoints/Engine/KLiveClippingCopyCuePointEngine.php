...
class KLiveClippingCopyCuePointEngine extends KLiveToVodCopyCuePointEngine
{
    ...
    protected function shouldCopyCuePoint($cuePoint)
    {
        ...
        KalturaLog::debug("Checking times to know if copy is needed for id[". $cuePoint->id ."]: start- [$cuePointStartTime], end- [$cuePointEndTime], calculatedEndTime - " . $cuePoint->calculatedEndTime);        if ($cuePointStartTime < 0 && is_null($cuePoint->calculatedEndTime))
