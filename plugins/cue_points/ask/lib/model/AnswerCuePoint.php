...
{
	const CUSTOM_DATA_ASK_USER_ENTRY_ID= 'askUserEntryId';
	...
	{
		$this->setType(AskPlugin::getCuePointTypeCoreValue(AskCuePointType::ASK_ANSWER));
	}

	public function setAskUserEntryId($v) {return $this->putInCustomData(self::CUSTOM_DATA_ASK_USER_ENTRY_ID, $v);}

	public function getAskUserEntryId() {return $this->getFromCustomData(self::CUSTOM_DATA_ASK_USER_ENTRY_ID);}
    ...
    public function setKuserId($v) {
		if (kCurrentContext::$is_admin_session) {
		    $userEntry = UserEntryPeer::retrieveByPK($this->getAskUserEntryId());
		    if ($userEntry) 
    ...
    */
	...
	{
		return AskPlugin::getCoreValue('MetadataObjectType', AskCuePointMetadataObjectType::ANSWER_CUE_POINT);
	}
