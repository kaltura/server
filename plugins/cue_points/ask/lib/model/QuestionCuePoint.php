...
class QuestionCuePoint extends CuePoint implements IMetadataObject
{
	...
	{
		$this->setType(AskPlugin::getCuePointTypeCoreValue(AskCuePointType::ASK_QUESTION));
	}
	...
	{
		return AskPlugin::getCoreValue('MetadataObjectType', AskCuePointMetadataObjectType::QUESTION_CUE_POINT);
	}
