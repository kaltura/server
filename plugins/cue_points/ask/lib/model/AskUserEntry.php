 ...
 * @subpackage model
 */
class AskUserEntry extends UserEntry{

	const ASK_OM_CLASS = 'AskUserEntry';
	/**
	 * @var float
	 */
	protected $score;
	...
	public function applyDefaultValues()
	{
		...
		$this->setType(AskPlugin::getCoreValue('UserEntryType' , AskUserEntryType::ASK));
	}
	...
	public function calculateScoreAndCorrectAnswers()
	{
		...
		$answerIds = $this->getAnswerIds();
		$questionType = AskPlugin::getCuePointTypeCoreValue(AskCuePointType::ASK_QUESTION);
