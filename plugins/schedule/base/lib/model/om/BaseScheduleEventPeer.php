...
abstract class BaseScheduleEventPeer {
	...
	/** the column name for the ORGANIZER_KUSER_ID field */
	const ORGANIZER_KUSER_ID = 'schedule_event.ORGANIZER_KUSER_ID';
	...
	const CATEGORIES_IDS = 'schedule_event.CATEGORIES_IDS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'PartnerId', 'Summary', 'Description', 'Type', 'Status', 'OriginalStartDate', 'StartDate', 'EndDate', 'ReferenceId', 'ClassificationType', 'GeoLat', 'GeoLong', 'Location', 'OrganizerKuserId', 'Priority', 'Sequence', 'RecuranceType', 'Duration', 'CategoriesIds', 'Contact', 'Comment', 'Tags', 'CreatedAt', 'UpdatedAt', 'CustomData', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'partnerId', 'summary', 'description', 'type', 'status', 'originalStartDate', 'startDate', 'endDate', 'referenceId', 'classificationType', 'geoLat', 'geoLong', 'location', 'organizerKuserId', 'priority', 'sequence', 'recuranceType', 'duration', 'categoriesIds', 'contact', 'comment', 'tags', 'createdAt', 'updatedAt', 'customData', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARENT_ID, self::PARTNER_ID, self::SUMMARY, self::DESCRIPTION, self::TYPE, self::STATUS, self::ORIGINAL_START_DATE, self::START_DATE, self::END_DATE, self::REFERENCE_ID, self::CLASSIFICATION_TYPE, self::GEO_LAT, self::GEO_LONG, self::LOCATION, self::ORGANIZER_KUSER_ID, self::PRIORITY, self::SEQUENCE, self::RECURANCE_TYPE, self::DURATION, self::CATEGORIES_IDS, self::CONTACT, self::COMMENT, self::TAGS, self::CREATED_AT, self::UPDATED_AT, self::CUSTOM_DATA, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'parent_id', 'partner_id', 'summary', 'description', 'type', 'status', 'original_start_date', 'start_date', 'end_date', 'reference_id', 'classification_type', 'geo_lat', 'geo_long', 'location', 'organizer_kuser_id', 'priority', 'sequence', 'recurance_type', 'duration', 'categories_ids', 'contact', 'comment', 'tags', 'created_at', 'updated_at', 'custom_data', ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ScheduleEventPeer::CATEGORIES_IDS);
