...
class KalturaScheduleErrors extends KalturaErrors
{
    ...
    const START_TIME_AND_LINKED_TO_CONFLICT           = "START_TIME_AND_LINKED_TO_CONFLICT;;Event cannot have both a start time and a linked to event. They may conflict";
	const START_TIME_AND_LINKED_TO_NOT_SET            = "START_TIME_AND_LINKED_TO_NOT_SET;;Event cannot must have Start Dime OR Linked To event set.";
	const RECURRENCE_LIKED_EVENT_CONFLICT             = "RECURRENCE_LIKED_EVENT_CONFLICT;;Recurring or recurrence events cannot be linked";
	const LINKED_TO_EVENT_NOT_FOUND_OR_NOT_ACCESSIBLE = "LINKED_TO_EVENT_NOT_FOUND_OR_NOT_ACCESSIBLE;;Cannot find or access the linked schedule event. Cannot set relative time";
}