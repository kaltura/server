 ...
 * @see Zend_Gdata_YouTube_Extension_Control
 */
require_once 'Zend/Gdata/YouTube/Extension/Access.php';
...
class Zend_Gdata_YouTube_VideoEntry extends Zend_Gdata_YouTube_MediaEntry
{
    ...
    public function getDOM($doc = null, $majorVersion = 1, $minorVersion = null)
    {
        ...
        foreach ($this->_access as $access) {
            $element->appendChild($access->getDOM($element->ownerDocument));
        }
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('app') . ':' . 'control':
            ...
            break;
		case $this->lookupNamespace('yt') . ':' . 'accessControl':
            $access = new Zend_Gdata_YouTube_Extension_Access();
    ...
    /**
     * Sets the accessControl relating to the video.
     *
     * @param array $access The access relating to the video
     * @return Zend_Gdata_YouTube_VideoEntry Provides a fluent interface
     */
    ...
    /**
     * Returns the access relating to the video.
     *
     * @return Zend_Gdata_Extension_Comments  The comments relating to the video
     */
