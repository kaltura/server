...
class WebexXmlAttendeeOrderType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlAttOrderByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlAttOrderByType>';
	...
	/**
	 * @param WebexXmlArray<WebexXmlAttOrderByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlAttOrderByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlAttOrderByType");
