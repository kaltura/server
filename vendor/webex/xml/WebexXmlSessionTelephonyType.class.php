...
class WebexXmlSessionTelephonyType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlSessTelephonySupportType
	 */
	...
	protected function getAttributeType($attributeName)
	{
		switch ($attributeName)
		{
			case 'telephonySupport':
				return 'WebexXmlSessTelephonySupportType';
	...
	/**
	 * @param WebexXmlSessTelephonySupportType $telephonySupport
	 */
	public function setTelephonySupport(WebexXmlSessTelephonySupportType $telephonySupport)
	{
		$this->telephonySupport = $telephonySupport;
	}
	
	/**
	 * @return WebexXmlSessTelephonySupportType $telephonySupport
	 */
