...
class WebexXmlEventTelephonyType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlEventTelephonySupportType
	 */
	...
	protected function getAttributeType($attributeName)
	{
		switch ($attributeName)
		{
			case 'telephonySupport':
				return 'WebexXmlEventTelephonySupportType';
	...
	/**
	 * @param WebexXmlEventTelephonySupportType $telephonySupport
	 */
	public function setTelephonySupport(WebexXmlEventTelephonySupportType $telephonySupport)
	{
		$this->telephonySupport = $telephonySupport;
	}
	
	/**
	 * @return WebexXmlEventTelephonySupportType $telephonySupport
	 */
	...
	/**
	 * @param boolean $muteUponEntry
	 */
	public function setMuteUponEntry($muteUponEntry)
	{
		$this->muteUponEntry = $muteUponEntry;
	}
	
	/**
	 * @return boolean $muteUponEntry
	 */
