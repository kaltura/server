...
class WebexXmlHistoryOrderEcHisType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlHistoryOrderEcHisByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlHistoryOrderEcHisByType>';
	...
	{
		return 'orderEcHisType';
	}
	
	/**
	 * @param WebexXmlArray<WebexXmlHistoryOrderEcHisByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlHistoryOrderEcHisByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlHistoryOrderEcHisByType");
