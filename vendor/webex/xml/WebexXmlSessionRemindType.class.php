...
class WebexXmlSessionRemindType extends WebexXmlRequestType
{
	/**
	 *
	 * @var boolean
	...
	/**
	 * @param WebexXml $attendees
	 */
	public function setAttendees(WebexXml $attendees)
	{
		$this->attendees = $attendees;
	}
	
	/**
	 * @return WebexXml $attendees
	 */
	...
	/**
	 * @param WebexXml $presenters
	 */
	public function setPresenters(WebexXml $presenters)
	{
		$this->presenters = $presenters;
	}
	
	/**
	 * @return WebexXml $presenters
	 */
