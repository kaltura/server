...
class WebexXmlUseOrderType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlUseOrderByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlUseOrderByType>';
	...
	/**
	 * @param WebexXmlArray<WebexXmlUseOrderByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlUseOrderByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlUseOrderByType");
