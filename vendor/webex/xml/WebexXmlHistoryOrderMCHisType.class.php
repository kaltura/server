...
class WebexXmlHistoryOrderMCHisType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlHistoryOrderMCHisByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlHistoryOrderMCHisByType>';
	...
	{
		return 'orderMCHisType';
	}
	
	/**
	 * @param WebexXmlArray<WebexXmlHistoryOrderMCHisByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlHistoryOrderMCHisByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlHistoryOrderMCHisByType");
