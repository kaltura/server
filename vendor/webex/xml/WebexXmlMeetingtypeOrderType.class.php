...
class WebexXmlMeetingtypeOrderType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlMtgtypeOrderByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlMtgtypeOrderByType>';
	...
	/**
	 * @param WebexXmlArray<WebexXmlMtgtypeOrderByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlMtgtypeOrderByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlMtgtypeOrderByType");
