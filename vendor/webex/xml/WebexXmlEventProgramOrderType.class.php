...
class WebexXmlEventProgramOrderType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlEventProgramOrderByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlEventProgramOrderByType>';
	...
	{
		return 'programOrderType';
	}
	
	/**
	 * @param WebexXmlArray<WebexXmlEventProgramOrderByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlEventProgramOrderByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlEventProgramOrderByType");
