...
class WebexXmlEventOrderType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlEventOrderByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlEventOrderByType>';
	...
	/**
	 * @param WebexXmlArray<WebexXmlEventOrderByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlEventOrderByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlEventOrderByType");
