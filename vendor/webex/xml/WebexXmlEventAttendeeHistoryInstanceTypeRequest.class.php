...
require_once(__DIR__ . '/WebexXmlEventAttendeeHistoryInstanceType.class.php');
require_once(__DIR__ . '/WebexXmlHistoryParticipantTypeType.class.php');
require_once(__DIR__ . '/WebexXmlArray.class.php');
require_once(__DIR__ . '/WebexXmlHistoryRegQandAType.class.php');

class WebexXmlEventAttendeeHistoryInstanceTypeRequest extends WebexXmlRequestBodyContent
{
	/**
	 *
	 * @var long
	...
	/**
	 *
	 * @var WebexXmlArray<WebexXmlHistoryRegQandAType>
	 */
	protected $regQandA;
	...
	{
		return 'history:eventAttendeeHistoryInstanceType';
	}
	...
	{
		return 'WebexXmlEventAttendeeHistoryInstanceType';
	}
	...
	/**
	 * @param WebexXmlArray<WebexXmlHistoryRegQandAType> $regQandA
	 */
	public function setRegQandA(WebexXmlArray $regQandA)
	{
		if($regQandA->getType() != 'WebexXmlHistoryRegQandAType')
			throw new WebexXmlException(get_class($this) . "::regQandA must be of type WebexXmlHistoryRegQandAType");
		
		$this->regQandA = $regQandA;
	}
