...
class WebexXmlHistoryOrderEcAttenHisType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlHistoryOrderEcAttenHisByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlHistoryOrderEcAttenHisByType>';
	...
	{
		return 'orderEcAttenHisType';
	}
	
	/**
	 * @param WebexXmlArray<WebexXmlHistoryOrderEcAttenHisByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlHistoryOrderEcAttenHisByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlHistoryOrderEcAttenHisByType");
