...
class WebexXmlHistoryOrderTCAttenHisType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlHistoryOrderTCAttenHisByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlHistoryOrderTCAttenHisByType>';
	...
	{
		return 'orderTCAttenHisType';
	}
	
	/**
	 * @param WebexXmlArray<WebexXmlHistoryOrderTCAttenHisByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlHistoryOrderTCAttenHisByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlHistoryOrderTCAttenHisByType");
