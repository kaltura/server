...
class WebexXmlHistoryOrderScAttenHisType extends WebexXmlRequestType
{
	/**
	 *
	 * @var WebexXmlArray<WebexXmlHistoryOrderScAttenHisByType>
	 */
	protected $orderBy;
	...
	protected function getAttributeType($attributeName)
	{
		...
		{
			case 'orderBy':
				return 'WebexXmlArray<WebexXmlHistoryOrderScAttenHisByType>';
	...
	{
		return 'orderScAttenHisType';
	}
	
	/**
	 * @param WebexXmlArray<WebexXmlHistoryOrderScAttenHisByType> $orderBy
	 */
	public function setOrderBy(WebexXmlArray $orderBy)
	{
		if($orderBy->getType() != 'WebexXmlHistoryOrderScAttenHisByType')
			throw new WebexXmlException(get_class($this) . "::orderBy must be of type WebexXmlHistoryOrderScAttenHisByType");
