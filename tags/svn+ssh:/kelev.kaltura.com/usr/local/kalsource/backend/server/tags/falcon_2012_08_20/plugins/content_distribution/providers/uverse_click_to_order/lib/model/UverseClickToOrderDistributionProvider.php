 ...
 * @subpackage lib
 */
class UverseClickToOrderDistributionProvider extends ConfigurableDistributionProvider
{
	/**
	 * @var UverseClickToOrderDistributionProvider
	 */
	...
	/**
	 * @return UverseClickToOrderDistributionProvider
	 */
	public static function get()
	{
		if(!self::$instance)
			self::$instance = new UverseClickToOrderDistributionProvider();
	...
	{
		return UverseClickToOrderDistributionPlugin::getDistributionProviderTypeCoreValue(UverseClickToOrderDistributionProviderType::UVERSE_CLICK_TO_ORDER);
	}
