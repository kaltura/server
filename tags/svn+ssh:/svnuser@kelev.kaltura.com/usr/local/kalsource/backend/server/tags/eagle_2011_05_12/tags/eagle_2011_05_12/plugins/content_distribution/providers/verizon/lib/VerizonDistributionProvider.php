 ...
 * @subpackage lib
 */
class VerizonDistributionProvider implements IDistributionProvider
{
	/**
	 * @var VerizonDistributionProvider
	 */
	...
	/**
	 * @return VerizonDistributionProvider
	 */
	public static function get()
	{
		if(!self::$instance)
			self::$instance = new VerizonDistributionProvider();
	...
	{
		return VerizonDistributionPlugin::getDistributionProviderTypeCoreValue(VerizonDistributionProviderType::VERIZON);
	}
	 ...
	 * @return string
	 */
	public static function generateSubmitXML($entryId, KalturaVerizonDistributionJobProviderData $providerData)
	{
		$xml = self::generateXML($entryId, $providerData);
		if(!$xml)
		{
	 ...
	 * @return DOMDocument
	 */
	public static function generateXML($entryId, KalturaVerizonDistributionJobProviderData $providerData)
	{
