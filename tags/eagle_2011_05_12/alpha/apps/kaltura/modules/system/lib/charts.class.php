...
class charts
{
	...
	//====================================
	public static function InsertChart( $flash_file, $library_path, $php_source, $width=400, $height=250, $bg_color="666666", $transparent=false, $license=null ){
	...
	//====================================
	public static function SendChartData( $chart=array() ){
