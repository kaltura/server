...
class FreewheelDistributionProvider implements IDistributionProvider
{
	...
	{
		if(kConf::hasParam('freewheel_update_required_entry_fields'))
			return kConf::get('freewheel_update_required_entry_fields');
	...
	{
		if(kConf::hasParam('freewheel_update_required_metadata_xpaths'))
			return kConf::get('freewheel_update_required_metadata_xpaths');
	 ...
	 * @return string
	 */
	public static function generateDeleteXML($entryId, KalturaFreewheelDistributionJobProviderData $providerData)
	{
	 ...
	 * @return string
	 */
	public static function generateUpdateXML($entryId, KalturaFreewheelDistributionJobProviderData $providerData)
	{
		$xml = self::generateXML($entryId, $providerData);
		if(!$xml)
		{
	 ...
	 * @return string
	 */
	public static function generateSubmitXML($entryId, KalturaFreewheelDistributionJobProviderData $providerData)
	{
		$xml = self::generateXML($entryId, $providerData);
		if(!$xml)
		{
	 ...
	 * @return DOMDocument
	 */
	public static function generateXML($entryId, KalturaFreewheelDistributionJobProviderData $providerData)
	{
