 ...
 */
class KalturaSynacorDistributionJobProviderData extends KalturaDistributionJobProviderData
{
	/**
	 * @var string
	 */
	...
	public function __construct(KalturaDistributionJobData $distributionJobData = null)
	{
		...
		if(!($distributionJobData->distributionProfile instanceof KalturaSynacorDistributionProfile))
			return;
