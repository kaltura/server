<?php
class kVisoFlowManager implements kBatchJobStatusEventConsumer
{
	/* (non-PHPdoc)
	...
	public function updatedJob(BatchJob $dbBatchJob, BatchJob $twinJob = null)
	{
		...
		$visoCoreValueType = kPluginableEnumsManager::apiToCore('DistributionProviderType', VisoDistributionPlugin::getApiValue(VisoDistributionProviderType::VISO));
		if ($data->getProviderType() != $visoCoreValueType)
			return true;
