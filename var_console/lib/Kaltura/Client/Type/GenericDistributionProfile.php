 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_GenericDistributionProfile extends Kaltura_Client_Type_DistributionProfile
{
	 ...
	 * 
	 *
	 * @var Kaltura_Client_Type_GenericDistributionProfileAction
	 */
	public $submitAction;
